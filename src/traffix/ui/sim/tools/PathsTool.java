...
public class PathsTool extends State {
    ...
    public void onMouseUp(MouseEvent e) {
      ...
      if (e.button == BTN_ADD) {
        ...
        if (nextNode == m_prevNode) {
          ...
          setNextState(new PathsTool(m_editor));
          return;
        ...
        // dont allow to add those stupid 1 node edges
        if (m_prevNode != null && m_prevNode.getPos().distanceTo(p)<0.0000001f) {
          setNextState(new PathsTool(m_editor));
          m_editor.getCanvas().redraw();
          return;
        }
  ...
  public PathsTool(IMapEditor editor) {
    super(editor);
